...
mixin DbConfig {
  ...
  Future<void> init(
      ...
      required Function(Database db) onCreateDb,
      required Function(Database db, int oldVersion, int newVersion)
          onUpgrade}) async {
  ...
  Future<List<dynamic>> filterDataById(
    ...
    return await _db.query(table, where: '$columnName = ?', whereArgs: [id]);
  }
